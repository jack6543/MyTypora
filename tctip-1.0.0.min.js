...
}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}Object.defineProperty(e,"__esModule" {
	value:!0
}
);
	var a=function() {
...
}(),c=n(2),u=r(c),s=n(1),l=function(t) {
	function e(t,n) {
	i(this,e);
...
return A(e,t),a(e,[ {
	...
	key:"parentDom",get:function() {
	return this._parentDom
}
}]),e}(u.default);
	e.default=l,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
...
function o(t,e) {
	...
	var n=function(t,e) {
	var n=[],r=e.getElementsByTagName("*"),i=new RegExp("(^|\\s)"+t+"(\\s|$)"),o=!0,A=!1,a=void 0;
	try {
	for(var c,u=r[Symbol.iterator]();
	!(o=(c=u.next()).done);
	o=!0) {
	var s=c.value;
	...
	var t=window.navigator.userAgent.toLowerCase(),e=["msie","firefox","chrome","opera","safari"],n=!0,r=!1,i=void 0;
	try {
...
}return"other"}Object.defineProperty(e,"__esModule" {
	value:!0
}
);
	var a="innerText";
	"firefox"===A()&&(e.textKey=a="textContent"),e.ready=r,e.createElement=i,e.getElementsByClassName=o,e.textKey=a},function(t,e,n) {
	"use strict";
	function r(t,e) {
	if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")
}
...
,set:function(t) {
	...
	t.exports= {
	name:"tctip",version:"1.0.0",description:"在页面右侧生成打赏界面的开源js插件",main:"dist/tctip.js",scripts: {
	build:"webpack --env build",dev:"webpack --progress --colors --watch --env dev",test:"mocha --compilers js:babel-core/register --colors ./test/*.spec.js","test:watch":"mocha --compilers js:babel-core/register --colors -w ./test/*.spec.js"
}
,devDependencies: {
	"babel-core":"~6.22.1","babel-eslint":"~7.1.1","babel-loader":"~6.2.10","babel-plugin-add-module-exports":"0.1.2","babel-preset-es2015":"6.22.0",chai:"3.4.1","css-loader":"^0.26.2",eslint:"^3.14.1","eslint-config-standard":"^6.2.1","eslint-loader":"^1.6.1","eslint-plugin-promise":"^3.4.0","eslint-plugin-standard":"^2.0.1",less:"^2.7.2","less-loader":"^2.2.3",mocha:"2.3.4","style-loader":"^0.13.2","url-loader":"^0.5.8",webpack:"2.2.1",yargs:"6.6.0"
}
,repository: {
	type:"git",url:"https://github.com/greedying/tctip.git"
}
,keywords:["tctip","tip","公众号","插件library","javascript"],author:"greedying <greedying@qq.com>",license:"MIT",bugs: {
	url:"https://github.com/greedying/tctip/issues"
}
,homepage:"https://github.com/greedying/tctip",dependencies: {
	...
	var i=n(20),o=r(i),A=new o.default.EventEmitter;
...
}(),c=n(0),u=r(c),s=n(9),l=r(s),f=n(10),p=r(f),h=function(t) {
	function e(t,n) {
	i(this,e);
...
return A(e,t),a(e,[ {
	key:"genDom",value:function() {
	var t=this;
	this.createDom( {
	className:"tctip",style:"top:"+this.config.top,onmouseover:function() {
	t.show()
}
,onmouseout:function() {
	t.hide()
}
}),this._btnBox=new l.default(this.config,this),this._mainBox=new p.default(this.config,this)}} {
	...
	e.default=h,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
...
function o(t) {
	...
	var e=[],n=!1,r=!0,i=!1,o=void 0;
	try {
	for(var a,c=t.list[Symbol.iterator]();
	!(r=(a=c.next()).done);
	r=!0) {
	var u=a.value;
	if(!u.type) {
...
var s=u.type;
	if(f.hasOwnProperty(s)&&(0,A.mergeObject)(u,f[s],!0),n?u.active="":u.active&&(n=!0),u.index=e.length,e.push(u),e.length>=5)break}}catch(t) {
	i=!0,o=t
}
finally {
	try {
...
}n||(e[0].active=!0),t.list=e}Object.defineProperty(e,"__esModule" {
	value:!0
}
),e.formatConfig=void 0;
	var A=n(16),a="10%",c=!0,u=["dashang","zanzhu"],s= {
	id:1,type:"dashang"
}
,l= {
	zanzhu: {
	1:n(33),2:n(34),3:n(35),4:n(36),5:n(37),6:n(38),7:n(39),8:n(40),9:n(41)
}
,dashang: {
	1:n(24),2:n(25),3:n(26),4:n(27),5:n(28),6:n(29),7:n(30),8:n(31),9:n(32)
}
},f= {
	alipay: {
	icon:n(42),name:"支付宝",desc:"微信公众号"
}
,wechat: {
	icon:n(45),name:"微信",desc:"微信公众号"
}
,bitcoin: {
	icon:n(43),name:"比特币",desc:"微信公众号"
}
,tenpay: {
	icon:n(44),name:"财付通",desc:"微信公众号"
}
};
	e.formatConfig=r},function(t,e,n) {
	"use strict";
	Object.defineProperty(e,"__esModule" {
	value:!0
}
...
,"script"))};
	var r=n(1),i=n(3).version,o="http://stat.tctip.com/stat/index";
	t.exports=e.default},function(t,e,n) {
	var r=n(18);
...
return A(e,t),a(e,[ {
	key:"genDom",value:function() {
	this.createDom( {
	className:"tctip-btn-box",href:"javascript:;
	"
}
,"a"),this._button=new l(this.config,this)}}]),e}(u.default),l=function(t) {
	function e(t,n) {
	i(this,e);
	var r=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
	return r.genDom(),r
...
,"img")}}]),e}(u.default);
	e.default=s,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
	return t&&t.__esModule?t: {
	default:t
...
}(),c=n(0),u=r(c),s=n(15),l=r(s),f=n(11),p=r(f),h=n(14),g=r(h),d=function(t) {
	function e(t,n) {
	i(this,e);
	var r=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
...
),this._title=new l.default( {
	},this),this._bodyBox=new p.default( {
	list:this.config.list
}
,this),this._footer=new g.default( {
	},this)
}
}]),e}(u.default);
	e.default=d,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
	return t&&t.__esModule?t: {
	default:t
...
}(),c=n(0),u=r(c),s=n(12),l=r(s),f=n(13),p=r(f),h=function(t) {
	function e(t,n) {
	i(this,e);
	var r=o(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
...
,this),this._QRDetail=new p.default(this.currentItem,this)}} {
	key:"currentItem",get:function() {
	if(!this._currentItem) {
	var t=!0,e=!1,n=void 0;
	try {
	for(var r,i=this.config.list[Symbol.iterator]();
	!(t=(r=i.next()).done);
	t=!0) {
	var o=r.value;
...
}}return this._currentItem},set:function(t) {
	this._currentItem=t
}
}]),e}(u.default);
	e.default=h,t.exports=e.default},function(t,e,n) {
...
}(),u=n(0),s=r(u),l=n(1),f=n(4),p=r(f),h=function(t) {
	function e(t,n) {
	o(this,e);
...
}]),e}(s.default),d=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
	return r._link=void 0,r._emitter=p.default,r.genDom(),r.addEvent(),r
}
return a(e,t),c(e,[ {
	key:"genDom",value:function() {
	this.createDom( {
...
return a(e,t),c(e,[ {
	...
	var t=this;
	this.createDom(i( {
	className:this.className,href:"javascript:",onmouseover:function() {
	t.mouseover()
}
...
}(),u=n(0),s=r(u),l=n(1),f=n(17),p=r(f),h=n(4),g=r(h),d=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
...
),this._box=new b(this.config,this)}}]),e}(s.default),b=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
	return r._qrTitle=void 0,r._qrCode=void 0,r._qrDesc=void 0,r._emitter=g.default,r.genDom(),r.addEvent(),r
}
return a(e,t),c(e,[ {
	key:"genDom",value:function() {
	this.createDom( {
	...
	key:"genChildren",value:function() {
	this._qrTitle=new y( {
	},this),this._qrCode=new m(this.config,this),this._qrDesc=new v( {
...
,l.textKey,"扫描二维码打赏"),"p")}}]),e}(s.default),m=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
	return r.genDom(),r
...
return a(e,t),c(e,[ {
	...
	key:"genQR",value:function() {
	this.config.qrImg?this.appendDom( {
	src:this.config.qrImg
}
,"img"):this.config.qrContent?this.dom.innerHTML=(0,p.default)(this.config.qrContent):console.error("没有可展示的二维码")}}]),e}(s.default),v=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
	return r.genDom(),r
...
,l.textKey,this.config.desc),"p")}}]),e}(s.default);
	e.default=d,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
	return t&&t.__esModule?t: {
...
}(),u=n(0),s=r(u),l=n(1),f=function(t) {
	function e(t,n) {
	o(this,e);
	var r=A(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t,n));
...
return a(e,t),c(e,[ {
	key:"genDom",value:function() {
	this.createDom(i( {
	href:"https://github.com/greedying/tctip",target:"_blank"
}
,l.textKey,"了解更多"),"a")}}]),e}(s.default);
	e.default=f,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t) {
	return t&&t.__esModule?t: {
	default:t
...
,l.textKey,"喜欢请打赏"),"h1")}}]),e}(s.default);
	e.default=f,t.exports=e.default},function(t,e,n) {
	"use strict";
	function r(t,e) {
...
),e.inArray=r,e.mergeObject=i},function(t,e,n) {
	"use strict";
	function r(t) {
	return t&&t.__esModule?t: {
	default:t
...
;var i=n(21),o=r(i),A="L",a=4,c=0,u=5;
	t.exports=e.default},function(t,e,n) {
	e=t.exports=n(19)(),e.push([t.i,".tctip {
	position:fixed;
	_position:absolute;
	right:0;
	z-index:10000;
...
",""])},function(t,e) {
	...
	e++) {
	var n=this[e];
	n[2]?t.push("@media "+n[2]+" {
	"+n[1]+"
}
"):t.push(n[1])}return t.join("")},t.i=function(e,n) {
...
else if(o(n))for(a=Array.prototype.slice.call(arguments,1),u=n.slice(),i=u.length,c=0;
	c<i;
	c++)u[c].apply(this,a);
...
if(!r(e))throw TypeError("listener must be a function");
	var i=!1;
	return n.listener=e,this.on(t,n),this},n.prototype.removeListener=function(t,e) {
	var n,i,A,a;
	if(!r(e))throw TypeError("listener must be a function");
...
if(i<0)return this;
	1===n.length?(n.length=0,delete this._events[t]):n.splice(i,1),this._events.removeListener&&this.emit("removeListener",t,e)}return this},n.prototype.removeAllListeners=function(t) {
	var e,n;
...
if(n=this._events[t],r(n))this.removeListener(t,n);
	...
	return delete this._events[t],this},n.prototype.listeners=function(t) {
	var e;
...
return 0},n.listenerCount=function(t,e) {
	...
	for(var r=new Array(e.length-t+n),i=0;
	i<e.length-t;
	i+=1)r[i]=e[i+t];
	return r
}
...
,i.multiply=function(e) {
	for(var n=new Array(i.getLength()+e.getLength()-1),r=0;
	r<i.getLength();
	r+=1)for(var o=0;
	o<e.getLength();
	o+=1)n[r+o]^=A.gexp(A.glog(i.getAt(r))+A.glog(e.getAt(o)));
	return t(n,0)
}
,i.mod=function(e) {
	if(i.getLength()-e.getLength()<0)return i;
	for(var n=A.glog(i.getAt(0))-A.glog(e.getAt(0)),r=new Array(i.getLength()),o=0;
	o<i.getLength();
	o+=1)r[o]=i.getAt(o);
	for(var o=0;
	o<e.getLength();
	o+=1)r[o]^=A.gexp(A.glog(e.getAt(o))+n);
	return t(r,0).mod(e)
}
,i}var e=function(e,n) {
	var i=236,A=17,p=e,h=r[n],g=null,d=0,y=null,m=new Array,v= {
	},E=function(t,e) {
...
return e}(d),w(0,0),w(d-7,0),w(0,d-7),M(),R(),B(t,e),p>=7&&D(t),null==y&&(y=U(p,h,m)),k(y,e)},w=function(t,e) {
	for(var n=-1;
	n<=7;
	n+=1)if(!(t+n<=-1||d<=t+n))for(var r=-1;
	r<=7;
	r+=1)e+r<=-1||d<=e+r||(0<=n&&n<=6&&(0==r||6==r)||0<=r&&r<=6&&(0==n||6==n)||2<=n&&n<=4&&2<=r&&r<=4?g[t+n][e+r]=!0:g[t+n][e+r]=!1)
}
,I=function() {
	for(var t=0,e=0,n=0;
	n<8;
...
return e},R=function() {
	for(var t=8;
	t<d-8;
	t+=1)null==g[t][6]&&(g[t][6]=t%2==0);
	for(var e=8;
	e<d-8;
	e+=1)null==g[6][e]&&(g[6][e]=e%2==0)
}
,M=function() {
	for(var t=o.getPatternPosition(p),e=0;
	e<t.length;
	e+=1)for(var n=0;
	n<t.length;
	n+=1) {
	var r=t[e],i=t[n];
	if(null==g[r][i])for(var A=-2;
	A<=2;
	A+=1)for(var a=-2;
	a<=2;
	a+=1)A==-2||2==A||a==-2||2==a||0==A&&0==a?g[r+A][i+a]=!0:g[r+A][i+a]=!1
}
},D=function(t) {
	for(var e=o.getBCHTypeNumber(p),n=0;
	n<18;
	n+=1) {
	var r=!t&&1==(e>>n&1);
...
for(var n=0;
	...
	for(var n=h<<3|e,r=o.getBCHTypeInfo(n),i=0;
	i<15;
	i+=1) {
	var A=!t&&1==(r>>i&1);
...
g[d-8][8]=!t},k=function(t,e) {
	for(var n=-1,r=d-1,i=7,A=0,a=o.getMaskFunction(e),c=d-1;
	c>0;
	c-=2)for(6==c&&(c-=1);
	) {
	for(var u=0;
...
if(r+=n,r<0||d<=r) {
	...
	for(var r=0,i=0,A=0,a=new Array(n.length),c=new Array(n.length),u=0;
	u<n.length;
	u+=1) {
	var s=n[u].dataCount,l=n[u].totalCount-s;
	i=Math.max(i,s),A=Math.max(A,l),a[u]=new Array(s);
	for(var f=0;
	f<a[u].length;
	f+=1)a[u][f]=255&e.getBuffer()[f+r];
	r+=s;
	var p=o.getErrorCorrectPolynomial(l),h=t(a[u],p.getLength()-1),g=h.mod(p);
	...
	f<n.length;
	f+=1)b+=n[f].totalCount;
	for(var y=new Array(b),m=0,f=0;
	f<i;
	f+=1)for(var u=0;
	u<n.length;
	u+=1)f<a[u].length&&(y[m]=a[u][f],m+=1);
	for(var f=0;
	f<A;
	f+=1)for(var u=0;
	u<n.length;
	u+=1)f<c[u].length&&(y[m]=c[u][f],m+=1);
	return y},U=function(t,e,n) {
	for(var r=a.getRSBlocks(t,e),u=c(),s=0;
	s<n.length;
	s+=1) {
	var l=n[s];
	u.put(l.getMode(),4),u.put(l.getLength(),o.getLengthInBits(l.getMode(),t)),l.write(u)
}
for(var f=0,s=0;
	s<r.length;
	s+=1)f+=r[s].dataCount;
	if(u.getLengthInBits()>8*f)throw new Error("code length overflow. ("+u.getLengthInBits()+">"+8*f+")");
	for(u.getLengthInBits()+4<=8*f&&u.put(0,4);
...
m.push(n),y=null},v.isDark=function(t,e) {
...
,v.createTableTag=function(t,e) {
	...
	var n="";
	n+='<table style="',n+=" border-width:0px;
	border-style:none;
	...
	for(var i=0;
	i<v.getModuleCount();
	i+=1)n+='<td style="',n+=" border-width:0px;
	border-style:none;
	",n+=" border-collapse:collapse;
	",n+=" padding:0px;
	margin:0px;
	",n+=" width:"+t+"px;
	",n+=" height:"+t+"px;
	",n+=" background-color:",n+=v.isDark(r,i)?"#000000":"#ffffff",n+=";
	",n+='"/>';
	n+="</tr>"
}
return n+="</tbody>",n+="</table>"},v.createSvgTag=function(t,e) {
	t=t||2,e="undefined"==typeof e?4*t:e;
	var n,r,i,o,A,a=v.getModuleCount()*t+2*e,c="";
	for(A="l"+t+",0 0,"+t+" -"+t+",0 0,-"+t+"z ",c+="<svg",c+=' width="'+a+'px"',c+=' height="'+a+'px"',c+=' xmlns="http://www.w3.org/2000/svg"',c+=">",c+='<path d="',i=0;
	i<v.getModuleCount();
	i+=1)for(o=i*t+e,n=0;
	n<v.getModuleCount();
	n+=1)v.isDark(i,n)&&(r=n*t+e,c+="M"+r+","+o+A);
	return c+='" stroke="transparent" fill="black"/>',c+="</svg>"
}
,v.createImgTag=function(t,e) {
	t=t||2,e="undefined"==typeof e?4*t:e;
	var n=v.getModuleCount()*t+2*e,r=e,i=n-e;
	return b(n,n,function(e,n) {
	if(r<=e&&e<i&&r<=n&&n<i) {
	var o=Math.floor((e-r)/t),A=Math.floor((n-r)/t);
...
return e},e.createStringToBytes=function(t,e) {
	var n=function() {
...
,i=0,o= {
	...
	var A=n.read();
	if(A==-1)break;
	var a=r(),c=r(),u=r(),s=String.fromCharCode(A<<8|a),l=c<<8|u;
	o[s]=l,i+=1
}
if(i!=e)throw new Error(i+" != "+e);
	return o}(),r="?".charCodeAt(0);
	return function(t) {
	for(var e=new Array,i=0;
	i<t.length;
	i+=1) {
...
,c.getMaskFunction=function(t) {
	switch(t) {
	case i.PATTERN000:return function(t,e) {
	return(t+e)%2==0
}
;case i.PATTERN001:return function(t,e) {
	return t%2==0
}
;case i.PATTERN010:return function(t,e) {
	return e%3==0
}
;case i.PATTERN011:return function(t,e) {
	return(t+e)%3==0
}
;case i.PATTERN100:return function(t,e) {
	return(Math.floor(t/2)+Math.floor(e/3))%2==0
}
;case i.PATTERN101:return function(t,e) {
	return t*e%2+t*e%3==0
}
;case i.PATTERN110:return function(t,e) {
	return(t*e%2+t*e%3)%2==0
}
;case i.PATTERN111:return function(t,e) {
	return(t*e%3+(t+e)%2)%2==0
}
;default:throw new Error("bad maskPattern:"+t)}},c.getErrorCorrectPolynomial=function(e) {
	for(var n=t([1],0),r=0;
	r<e;
	r+=1)n=n.multiply(t([1,A.gexp(r)],0));
	return n
}
,c.getLengthInBits=function(t,e) {
	...
	for(var e=t.getModuleCount(),n=0,r=0;
	r<e;
	r+=1)for(var i=0;
	i<e;
	i+=1) {
	for(var o=0,A=t.isDark(r,i),a=-1;
	a<=1;
	a+=1)if(!(r+a<0||e<=r+a))for(var c=-1;
	c<=1;
	c+=1)i+c<0||e<=i+c||0==a&&0==c||A==t.isDark(r+a,i+c)&&(o+=1);
	o>5&&(n+=3+o-5)
}
for(var r=0;
	r<e-1;
...
for(var r=0;
	...
	r+=1)for(var i=0;
	i<e-6;
	i+=1)t.isDark(r,i)&&!t.isDark(r,i+1)&&t.isDark(r,i+2)&&t.isDark(r,i+3)&&t.isDark(r,i+4)&&!t.isDark(r,i+5)&&t.isDark(r,i+6)&&(n+=40);
	for(var i=0;
	i<e;
	i+=1)for(var r=0;
	r<e-6;
	r+=1)t.isDark(r,i)&&!t.isDark(r+1,i)&&t.isDark(r+2,i)&&t.isDark(r+3,i)&&t.isDark(r+4,i)&&!t.isDark(r+5,i)&&t.isDark(r+6,i)&&(n+=40);
	for(var s=0,i=0;
	i<e;
	i+=1)for(var r=0;
	r<e;
	r+=1)t.isDark(r,i)&&(s+=1);
	var l=Math.abs(100*s/e/e-50)/5;
	return n+=10*l},c}(),A=function() {
	for(var t=new Array(256),e=new Array(256),n=0;
	n<8;
	n+=1)t[n]=1<<n;
	for(var n=8;
	n<256;
	n+=1)t[n]=t[n-4]^t[n-5]^t[n-6]^t[n-8];
	for(var n=0;
	n<255;
	n+=1)e[t[n]]=n;
	var r= {
...
,n= {
	...
	case r.L:return t[4*(e-1)+0];
	case r.M:return t[4*(e-1)+1];
	case r.Q:return t[4*(e-1)+2];
	case r.H:return t[4*(e-1)+3];
	default:return
}
};
	return n.getRSBlocks=function(t,n) {
	var r=i(t,n);
	if("undefined"==typeof r)throw new Error("bad rs block @ typeNumber:"+t+"/errorCorrectionLevel:"+n);
	for(var o=r.length/3,A=new Array,a=0;
	a<o;
	a+=1)for(var c=r[3*a+0],u=r[3*a+1],s=r[3*a+2],l=0;
	l<c;
	l+=1)A.push(e(u,s));
	return A
}
...
,i.write=function(t) {
	for(var e=r,n=0;
	n+1<e.length;
	)t.put(45*o(e.charAt(n))+o(e.charAt(n+1)),11),n+=2;
...
,o},f=function(t) {
	var r=n.MODE_KANJI,i=e.stringToBytes(t);
	!function(t,n) {
...
r=192*(r>>>8&255)+(255&r),t.put(r,13),n+=2}if(n<e.length)throw"illegal char at "+(n+1)},o},p=function() {
	var t=new Array,e= {
	};
...
throw new Error("n:"+t)};
	...
	for(t=t<<8|255&r,e+=8,n+=1;
	e>=6;
	)o(t>>>e-6),e-=6
}
,i.flush=function() {
	if(e>0&&(o(t<<6-e),t=0,e=0),n%3!=0)for(var i=3-n%3,A=0;
	A<i;
	A+=1)r+="="
}
,i.toString=function() {
...
var t=e.charAt(n);
	...
	t.match(/^\s$/)||(r=r<<6|A(t.charCodeAt(0)),i+=6)}var o=r>>>i-8&255;
	return i-=8,o};
	var A=function(t) {
...
,i},a=function(t) {
	for(var e=1<<t,n=(1<<t)+1,r=t+1,o=c(),a=0;
	a<e;
	a+=1)o.add(String.fromCharCode(a));
	o.add(String.fromCharCode(e)),o.add(String.fromCharCode(n));
	var u=p(),s=A(u);
	s.write(e,r);
	var l=0,f=String.fromCharCode(i[l]);
	for(l+=1;
	l<i.length;
	) {
	var h=String.fromCharCode(i[l]);
	l+=1,o.contains(f+h)?f+=h:(s.write(o.indexOf(f),r),o.size()<4095&&(o.size()==1<<r&&(r+=1),o.add(f+h)),f=h)
}
return s.write(o.indexOf(f),r),s.write(n,r),s.flush(),u.toByteArray()},c=function() {
	var t= {
	},e=0,n= {
	};
...
,n};
	return o},b=function(t,e,n,r) {
	for(var i=d(t,e),o=0;
	o<e;
	o+=1)for(var A=0;
	A<t;
	A+=1)i.setPixel(A,o,n(A,o));
	var a=p();
	i.write(a);
	for(var c=h(),u=a.toByteArray(),s=0;
	s<u.length;
	s+=1)c.writeByte(u[s]);
	c.flush();
	var l="";
	return l+="<img",l+=' src="',l+="data:image/gif;
	base64,",l+=c,l+='"',l+=' width="',l+=t,l+='"',l+=' height="',l+=e,l+='"',r&&(l+=' alt="',l+=r,l+='"'),l+="/>"
}
;return e}();
	!function(n) {
...
(function() {
	...
	for(var o=0;
	o<i.parts.length;
	o++)i.parts[o](r.parts[o]);
	for(;
	o<r.parts.length;
	o++)i.parts.push(c(r.parts[o],e))
}
else {
	for(var A=[],o=0;
	o<r.parts.length;
	o++)A.push(c(r.parts[o],e));
	f[r.id]= {
	id:r.id,refs:1,parts:A
}
}}}function r(t) {
	for(var e=[],n= {
	},r=0;
	r<t.length;
	r++) {
	var i=t[r],o=i[0],A=i[1],a=i[2],c=i[3],u= {
	css:A,media:a,sourceMap:c
}
...
function c(t,e) {
	...
	t.href=URL.createObjectURL(i),o&&URL.revokeObjectURL(o)}var f= {
	},p=function(t) {
	var e;
	return function() {
	...
	e=e|| {
	},"undefined"==typeof e.singleton&&(e.singleton=h()),"undefined"==typeof e.insertAt&&(e.insertAt="bottom");
	var i=r(t);
...
}(),c=n(1),u=n(6),s=n(7),l=r(s),f=n(5),p=r(f),h=n(2),g=r(h);
	n(8);
	var d=n(3).version,b=function(t) {
	function e() {
...
return A(e,t),a(e,[ {
	...
	key:"getTctipDom",value:function() {
